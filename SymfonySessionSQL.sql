...
-- Listage des données de la table symfonysession.categorie : ~4 rows (environ)
...
-- Listage des données de la table symfonysession.cours : ~9 rows (environ)
...
-- Listage des données de la table symfonysession.formation : ~4 rows (environ)
...
INSERT INTO `session` (`id`, `formation_id`, `nom_session`, `place`, `date_debut`, `date_fin`) VALUES
	...
	(4, 1, 'Développeur web 2', 12, '2022-06-28', '2023-05-03');
